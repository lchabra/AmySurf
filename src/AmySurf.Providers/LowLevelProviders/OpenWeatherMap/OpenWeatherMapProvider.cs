...
{
    public class OpenWeatherMapProvider : IWeatherForecastsProvider
    {
        ...
        public async Task<GetWeatherForecastResponse> GetForecastAsync(string spotId)
        {
            ...
            return OpenWeatherMapAdapter.ArrangeForecastCore(spotId, yerstedayForecastRaw, todayForecastRaw, futureForecastRaw);
        }
    ...
    public class OpenWeatherMapForecastPastRaw
    {
    ...
    public class OpenWeatherMapForecastFutureRaw
    {
