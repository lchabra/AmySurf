...
namespace AmySurf.Adapters
{
    internal static class OpenWeatherMapAdapter
    {
        public static GetWeatherForecastResponse ArrangeForecastCore(
            string spotId,
        ...
        private static List<HourlyWeather> GetHourlyWeather(OpenWeatherMapForecastPastRaw? yerstedayForecastRaw, OpenWeatherMapForecastPastRaw? todayForecastRaw, OpenWeatherMapForecastFutureRaw? futureForecastRaw)
        {
        ...
        private static void ConvertToAppMesurementUnits(OpenWeatherMapForecastPastRaw? yerstedayForecastRaw, OpenWeatherMapForecastPastRaw? todayForecastRaw, OpenWeatherMapForecastFutureRaw? futureForecastRaw)
        {
            if (!(yerstedayForecastRaw is null))
            {
        ...
        private static WeatherDescription GetWeatherDescription(int id)
        {
            return id switch
            {
