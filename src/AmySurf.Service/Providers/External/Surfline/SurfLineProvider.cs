...
internal sealed class SurflineProvider : ISurfForecastProvider
{
...
public sealed class ForecastRaw
{
...
public sealed class SunriseSunsetTimeRaw
{
    public int Midnight { get; set; }
    public int Sunrise { get; set; }
    public int Sunset { get; set; }
}
public sealed class TideLocationRaw
{
...
public sealed class SurflineWeatherRaw
{
...
public sealed class WindRaw
{
    public double Speed { get; set; }
    public double Direction { get; set; }
}
public sealed class SurfRaw
{
    public double Min { get; set; }
    public double Max { get; set; }
}
public sealed class SwellRaw
{
