...
internal sealed class OpenWeatherMapProvider : IWeatherForecastsProvider
{
    ...
    {
        long timeStampUtcMinus60s = DateTimeHelper.TimestampUTCNow - 60;
        long timeStampUtcYersteday = DateTimeHelper.TimestampUTCNow - 86400;
        ...
        // todayForecastRaw = await GetForecastRawPast(spotId, timeStampUtcMinus60s).ConfigureAwait(false);
...
public sealed record OpenWeatherProviderSpotOptions(double Latitude, double Longitude) : IDataProviderSpotOptions;
