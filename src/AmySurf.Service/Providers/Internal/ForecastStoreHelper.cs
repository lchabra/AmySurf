...
internal static class ForecastStoreHelper
{
    ...
    public static string GetDataDirectory(FileSystemForecastStoreOptions options)
    {
        ...
        var dataDirectory = Path.Combine(personalPath, ".amysurf", options.DataSubDirectory ?? string.Empty, "data");
    ...
    public static string GetDataDirectoryOld(FileSystemForecastStoreOptions options)
    {
        var value = options.DataSubDirectory;
